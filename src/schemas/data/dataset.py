...
class ETLSpecificDatasetFields(BaseModel):
    sample_id: str = Field(default="sample_id", description="Sample id of the dataset.")
...
class BaseHuggingFaceDatasetSchema(BaseModel):
    ...
    schematism_name: str = Field(default="schematism_name", description="Name of schematism.")
