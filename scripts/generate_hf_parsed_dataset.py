...
Attributes:
    ...
    config_manager (ShapefileGeneratorConfig): Configuration object defining paths and key
...
from notarius.infrastructure.persistence.shapefile_repository import (
    ShapefileGeneratorConfig,
    ShapefileGenerator,
)
from notarius.shared.constants import REPOSITORY_ROOT, TMP_DIR
from notarius.shared.logger import setup_logging
